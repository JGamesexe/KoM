            ...
            if (isSign(ev.getClickedBlock().getType())) {
                ...
                if ((s.getLine(0).equalsIgnoreCase("[Server]")) &&
                    ...
                    if (cp != null) {
                        ...
                        int dano = 1;
                        Material namao = ev.getPlayer().getInventory().getItemInMainHand().getType();
                        ...
                        if (dano > 1) {
                            p.getInventory().getItemInMainHand().setDurability((short) (p.getInventory().getItemInMainHand().getDurability() + 2));
