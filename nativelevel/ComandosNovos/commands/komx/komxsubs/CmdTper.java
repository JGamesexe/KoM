...
public class CmdTper extends SubCmd {
    ...
    public void execute(CommandSender cs, String[] args) {
        ...
        if (p.getInventory().getItemInMainHand().getType() == Material.BOOK_AND_QUILL) {
            BungLocation local = BookPortal.getLocationFromBook(p.getInventory().getItemInMainHand());
            if (local == null) {
