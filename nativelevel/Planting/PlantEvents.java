...
public class PlantEvents {
    ...
    public static void plantaBlock(final BlockPlaceEvent ev) {
        ...
        if (plant.classe.equals(Jobs.Classe.Fazendeiro) && GeneralUtils.getHighestBlockYAt(ev.getBlock().getLocation()) > ev.getBlock().getY()) {
            ev.setCancelled(true);
            ev.getPlayer().sendMessage("Plantas precisam de contato direto com o céu!");
            return;
        }
