...
/*    */ {
/* 36 */
        ListaReinicio.add(datahoje + " 07:00:00");
/* 37 */     //ListaReinicio.add(datahoje + " 12:00:00");
/* 38 */     //ListaReinicio.add(datahoje + " 16:00:00");
/* 39 */     //ListaReinicio.add(datahoje + " 20:00:00");
/*    */     
/* 41 */
        ListaReinicio.add(datahoje + " 23:59:50");
/* 42 */
        new RebootTimerThread().start();
/* 43 */
        for (String d : ListaReinicio) {
/* 44 */
            Date d1 = new Date();
/* 45 */
            Date d2 = DataHoraAtual.parse(d);
/* 46 */
            long diff = (d2.getTime() - d1.getTime()) / 1000L;
/* 47 */
            if (diff > 0L)
/*    */ {
/*    */ 
/* 50 */
                ProximoRebootDate = d2;
/* 51 */
                ProximoRebootEmSegundos = diff;
/* 52 */
                return;
/*    */
            }
...
/* 55 */
        ProximoRebootEmSegundos = 10800L;
/*    */
    }
