...
/* 23 */
            Player p = (Player) cs;
/* 24 */
            if ((p.isOp()) || (p.hasPermission("cmdmania.ops"))) {
/* 25 */
                p.sendMessage("§c§lTotal de pessoas com OP §f(§2" + Bukkit.getOperators().size() + "§f)");
/* 26 */
...
/* 30 */
                String operators = sb.toString().substring(0, sb.length() - 2);
/* 31 */
                p.sendMessage(operators);
/*    */
            } else {
/* 33 */
